...
const DB = {
    ...
    towns: {
        ...
        "town_sherine": {   // 🔮 新安全區：席琳神殿
            ...
            npcs: [
                ...
                { id: "npc_zana", n: "紮那", title: "製圖大師", type: "mapmod", d: "異界的裂隙正在擴散，製圖大師紮那能指引你面對更強大的怪物。等級 30 以上可開啟地圖詞綴。" }
            ]
        },
	...
	skills: {
        ...
        "sk_poison_curse": { n: "毒咒", type: "atk", tier: 2, reqM: 8, reqE: 16, mp: 10, dmgType: "magic", status: { kind: "poison", pbase: 100, dur: 30, tick: 3, dmg: [1, 3] }, msg: "你使目標中毒了。" },
